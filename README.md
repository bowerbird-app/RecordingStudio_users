...
Show puts **Edit** in the PageTitle actions slot and keeps **Swap this photo** next to the avatar. Edit stacks First name, Last name, and Time zone as full-width rows and groups Update profile / Cancel in a ButtonGroup. Subtitles stay plain: "Your name, email, and photo." and "Change your name, time zone, or photo."
