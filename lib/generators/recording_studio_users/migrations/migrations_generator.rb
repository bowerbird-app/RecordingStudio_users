...
module RecordingStudioUsers
  module Generators
    # Generator to install RecordingStudioUsers migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_users:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioUsers migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioUsers engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_users_pages.rb")
