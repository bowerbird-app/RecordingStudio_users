...
module RecordingStudioUser
  module Generators
    # Generator to install RecordingStudioUser migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_user:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioUser migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioUser engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_user_pages.rb")
