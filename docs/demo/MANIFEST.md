...
Dummy installs released `recording_studio_terms_and_conditions` `v0.6.2`. Users detects that gem and pending live Terms on create-password, falling back to the first live-Terms root when the current workspace has none. Production Users stays independent of a gemspec pin. Dummy Agree drops the “Terms updated” alert.
