...
Dummy installs released `recording_studio_terms_and_conditions` `v0.6.2`. Users detects that gem and pending live Terms on create-password. Production Users stays independent of a gemspec pin.
