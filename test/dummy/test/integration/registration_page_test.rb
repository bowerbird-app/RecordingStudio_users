...
class RegistrationPageTest < ActionDispatch::IntegrationTest
  test "sign up offers password and OTP choices" do
    get new_user_registration_path

    assert_response :success
    assert_select "body", text: /Continue with password/
    assert_select "body", text: /Continue with email OTP/
  end

  test "password sign up path paints Flatpack fields" do
  ...
  test "password sign up omits confirmation when the host turns the flag off" do
