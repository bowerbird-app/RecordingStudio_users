...
class UsersTncBoundaryTest < Minitest::Test
  ...
  def test_dummy_pins_released_tnc_tag
    ...
    assert_includes dummy_gemfile, 'tag: "v0.6.5"'
    ...
    assert_includes dummy_lock, "tag: v0.6.5"
    assert_includes dummy_lock, "recording_studio_terms_and_conditions (0.6.5)"
    assert_includes dummy_lock, "2ca87e22552f7cc8ae0c6a86fc9ac70439bb7187"
