...
class RecordingStudioUsersTest < Minitest::Test
  def test_version_matches_release
    assert_equal "0.1.0", ::RecordingStudioUsers::VERSION
  end
  ...
  def test_dummy_home_page_links_to_membership_management
    view_path = File.expand_path("dummy/app/views/home/index.html.erb", __dir__)
    view_source = File.read(view_path)

    assert_includes view_source, 'title: "Recording Studio Users"'
    assert_includes view_source, "recording_studio_users.root_path"
  ...
  def test_engine_does_not_ship_a_home_view
    view_path = File.expand_path("../app/views/recording_studio_users/home/index.html.erb", __dir__)
