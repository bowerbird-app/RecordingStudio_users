  ...
  module Services
    class BaseServiceTest < Minitest::Test
      ...
      def test_before_and_after_hooks_receive_service_context
        ...
        RecordingStudioUsers.configuration.hooks.before_service do |service_class, args|
          before_calls << [service_class, args]
        end
        RecordingStudioUsers.configuration.hooks.after_service do |service_class, result|
      ...
      def test_around_hook_wraps_service_execution
        events = []
        RecordingStudioUsers.configuration.hooks.around_service do |service, block|
      ...
      def test_hooks_are_skipped_when_configuration_has_no_hooks
        ...
        RecordingStudioUsers.stub(:configuration, configuration) do
      ...
      def test_default_service_args_are_empty_hash
        received_args = nil
        RecordingStudioUsers.configuration.hooks.before_service do |_service_class, args|
          received_args = args
        end
