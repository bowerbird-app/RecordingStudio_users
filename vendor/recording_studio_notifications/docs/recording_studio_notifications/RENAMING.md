...
- **snake_case**: `recording_studio_notifications` → `new_gem_name`
- **PascalCase**: `RecordingStudioNotifications` → `NewGemName`
...
- `docs/recording_studio_notifications/` - **Preserved as architectural reference**
  - These files document the original recording_studio_notifications structure
...
- What patterns and conventions come from the recording_studio_notifications
