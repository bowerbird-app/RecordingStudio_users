...
module RecordingStudioNotifications
  ...
  #   RecordingStudioNotifications.configuration.hooks.after_initialize do
  ...
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioNotifications::Hooks] Error in #{event_name} hook: #{error.message}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioNotifications.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioNotifications.configuration.hooks.run_around(event_name, context, &)
      end
