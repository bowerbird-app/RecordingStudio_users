...
module RecordingStudioNotifications
  module Generators
    # Generator to install RecordingStudioNotifications migrations into the host application.
    #
    # Usage:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioNotifications migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioNotifications engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_notifications_pages.rb")
