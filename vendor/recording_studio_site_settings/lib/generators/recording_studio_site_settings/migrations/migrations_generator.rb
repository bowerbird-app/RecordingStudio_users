...
module RecordingStudioSiteSettings
  module Generators
    # Generator to install RecordingStudioSiteSettings migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_site_settings:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioSiteSettings migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioSiteSettings engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_site_settings_pages.rb")
