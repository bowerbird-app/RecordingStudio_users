...
module RecordingStudioNotificationsPush
  module Generators
    # Generator to install RecordingStudioNotificationsPush migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_notifications_push:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioNotificationsPush migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioNotificationsPush engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_notifications_push_pages.rb")
