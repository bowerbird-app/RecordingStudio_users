...
module RecordingStudioUser
  class IdentitiesController < ApplicationController
    ...
    def destroy
      ...
      redirect_to edit_profile_path, notice: "Sign-in method disconnected."
    rescue Omniauth::LastSignInMethodError => e
      redirect_to edit_profile_path, alert: e.message
    rescue ActiveRecord::RecordNotFound
      redirect_to edit_profile_path, alert: "That sign-in method is not connected."
    end
